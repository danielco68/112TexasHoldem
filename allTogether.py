...
def init(data): #Initalizes variables to setup game
    ...
    data.cardImages = makeImageDict("Assets/cards/")
    ...
    if data.numPlayers == 2:
        ...
        data.op0Card1 = PhotoImage(file = "Assets/cards/" + data.opponentCards1[0])
        data.op0Card2 = PhotoImage(file = "Assets/cards/" + data.opponentCards1[1])
    else:
        data.opponentCards1 = imageLoader(data.game.playerHands[1], data)
        ...
        data.op0Card1 = PhotoImage(file = "Assets/cards/" + data.opponentCards1[0])
        data.op0Card2 = PhotoImage(file = "Assets/cards/" + data.opponentCards1[1])
        data.op1Card1 = PhotoImage(file = "Assets/cards/" + data.opponentCards2[0])
        data.op1Card2 = PhotoImage(file = "Assets/cards/" + data.opponentCards2[1])
        data.op2Card1 = PhotoImage(file = "Assets/cards/" + data.opponentCards3[0])
        data.op2Card2 = PhotoImage(file = "Assets/cards/" + data.opponentCards3[1])
    data.card1 = PhotoImage(file = "Assets/cards/" + data.currPlayerCards[0])
    data.card2 = PhotoImage(file = "Assets/cards/" + data.currPlayerCards[1])
    data.back = PhotoImage(file = "Assets/cards/back.gif")
    data.menuBackground = PhotoImage(file = "Assets/menuBackground.gif")
    data.rotatedBack = PhotoImage(file = "Assets/cards/rotatedBack.gif")
    ...
    data.gameBackground = PhotoImage(file = "Assets/gameBackground.gif")
    data.game.simulatedFlop()
    data.flopCards = imageLoader(data.game.simulatedFlopCards, data)
    data.flop1 = PhotoImage(file = "Assets/cards/" + data.flopCards[0])
    data.flop2 = PhotoImage(file = "Assets/cards/" + data.flopCards[1])
    data.flop3 = PhotoImage(file = "Assets/cards/" + data.flopCards[2])
    data.flop4 = PhotoImage(file = "Assets/cards/" + data.flopCards[3])
    data.flop5 = PhotoImage(file = "Assets/cards/" + data.flopCards[4])
    data.slider = 0
    data.theatreModeButton = Button(data.width/2 + 100, data.height/2, "Theatre Mode")
    data.curt1 = PhotoImage(file = "Assets/curt#1.gif")
    data.curt2 = PhotoImage(file = "Assets/curt#2.gif")
